...
function installToMediaWikiRoot {
	...
	if [ "$WNBY" != "" ]
	then
		composer require 'mediawiki/whats-nearby='$WNBY --prefer-source --update-with-dependencies
	else
		composer init --stability dev
		composer require "mediawiki/whats-nearby:dev-master" --prefer-source --dev --update-with-dependencies
